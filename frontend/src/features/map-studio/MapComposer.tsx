...
const mapComposerCopy = {
  en: {
    ...
    emptyHint: 'This creates the cross-shaped expansion layout used by Droi AI map stitching.',
  ...
  zh: {
    ...
    emptyHint: '这里会生成和 Droi AI 地图拼接一样的十字扩图布局。',
    preview: '拼接预览',
  ...
  ja: {
    ...
    emptyHint: 'Droi AI のマップ結合と同じ十字型拡張レイアウトを生成します。',
    preview: '結合プレビュー',
